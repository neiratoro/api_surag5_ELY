...
public class validacionPaciente {
    ...
    // 2. crear un metodo para validar el campo que quiero crear.
    // para validar datos se devuelve boolean.
    //validar pernite filtrar "String" = valida datos (patron standar,(solo letras, solo numeros)
